...
fun main3() {
    ...
    val weights = listOf(
        Weighting(72.7f, LocalDate.parse("2025-01-18")),
        Weighting(72.7f, LocalDate.parse("2025-01-20")),
        Weighting(72.7f, LocalDate.parse("2025-01-27")),
    )
    /*val result = calculator.calculateWeightPoints(weights)
    result.forEach {
        println(it)
    }*/
}
...
fun main() {
   /* val calculator = WeightChartCalculator()
    val target = 70f
    val weights = listOf(
        Weighting(73.7f, LocalDate.parse("2024-02-18")),
        //Weighting(93.1f, LocalDate.parse("2024-07-01")),
        Weighting(72.0f, LocalDate.parse("2024-07-03")),
        Weighting(72.7f, LocalDate.parse("2025-01-20")),
        Weighting(70.1f, LocalDate.parse("2025-01-27")),
    )
    val result = calculator.calculateWeightChart(target, weights)
    result.scope.apply {
        println("bottomWeight = $bottomWeight")
        println("topWeight = $topWeight")
